# ⚡ 高速装填・テンションメカニクス (Minecraft 26.3)
...
> ☕ *個人開発者ノート*: 重衝撃弾道と低伸するスナイパーライフル感覚の射撃を気に入っていただけたら、ぜひ [Ko-fi](https://ko-fi.com/dasikigaijin) でのご支援をお願いします！

---

## 🔗 関連ドキュメント
- [[Heavy-Impact Ballistics|ja_jp-26.3-Heavy-Impact-Ballistics]]
- [[Configuration & Dynamic GameRules|ja_jp-26.3-Configuration-and-GameRules]]
- [[Architecture & Mixins|ja_jp-26.3-Architecture-and-Mixins]]
- [[Return to Overview Portal|ja_jp-26.3-Home]]
