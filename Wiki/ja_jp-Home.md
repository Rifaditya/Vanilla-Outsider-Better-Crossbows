...
| :--- | :--- | :--- | :---: | :--- |
| **Minecraft 26.3** | `1.0.14+26.3` | Fabric Loader `>=0.19.3` / Java 25 | 🟢 現行バージョン | [[👉 MC 26.3 Wikiへ入る|ja_jp-26.3-Home]] |
| **Minecraft 26.2** | `1.0.14+26.2` | Fabric Loader `>=0.19.3` / Java 25 | 🟡 パリティ版 | [[👉 MC 26.2 Wikiへ入る|ja_jp-26.2-Home]] |

---

## 🌟 主要機能の概要

- **[[重衝撃弾道メカニクス|ja_jp-26.3-Heavy-Impact-Ballistics]]**:
...
- **[[高速装填・テンション調整|ja_jp-26.3-Quick-Draw-Mechanics]]**:
...
- **[[アーキテクチャとMixin解説|ja_jp-26.3-Architecture-and-Mixins]]**:
