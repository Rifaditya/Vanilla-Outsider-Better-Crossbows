# 🚀 Heavy-Impact Ballistics (Minecraft 26.2)
...
| **Java Mixin Implementations** | [`CrossbowItemMixin.java`](file:///src/main/java/net/vanillaoutsider/bettercrossbows/mixin/CrossbowItemMixin.java), [`AbstractArrowMixin.java`](file:///src/main/java/net/vanillaoutsider/bettercrossbows/mixin/AbstractArrowMixin.java) |
...
## 3. Mathematical Formulas & Kinematics
...
## 4. Visual Ballistics Comparison Diagram
...
## 6. Comprehensive Ballistics Reference Table
...
Uses MixinExtras `@WrapOperation` on the internal launch instruction:
```java
@WrapOperation(
...
Intercepts `getDefaultGravity()` at `RETURN`:
```java
