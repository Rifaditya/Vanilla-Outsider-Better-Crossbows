# 🏹 Minecraft 26.3 — Portail Better Crossbows
...
## 🎯 Bienvenue sur le portail Minecraft 26.3

Ce portail détaille **Better Crossbows** pour **Minecraft 26.3** (`1.0.14+26.3`).

Minecraft 26.3 apporte des mécaniques de combat modernisées, Java 25 et Fabric API (`0.156.1+26.3`). Better Crossbows transforme l'arbalète avec une balistique haute vélocité, une trajectoire aplanie et des GameRules serveur.

---

## 🧭 Arborescence de la documentation MC 26.3
...
[ 26.3 Home Portal ]
        |
        +---> [[🚀 Heavy-Impact Ballistics|fr_fr-26.3-Heavy-Impact-Ballistics]]
        |       (Kinetic speed, gravity scaling math, Ballistics enchantment, sonic shockwaves)
        |
        +---> [[⚡ Quick Draw Mechanics|fr_fr-26.3-Quick-Draw-Mechanics]]
        |       (Reload ticks, Quick Charge integration, tension curves)
        |
        +---> [[⚙️ Configuration & GameRules|fr_fr-26.3-Configuration-and-GameRules]]
...
## 📋 Spécifications techniques MC 26.3
...
## 🌟 Points clés et nouveautés (26.3)
...
- [[Switch to Minecraft 26.2|fr_fr-26.2-Home]]
