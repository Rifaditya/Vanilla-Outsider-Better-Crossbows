# ⚡ Быстрая перезарядка и натяжение (Minecraft 26.2)
...
## 3. Математические формулы и кривые натяжения
...
## 4. Диаграмма конечного автомата натяжения
...
## 5. Спецификация данных SNBT заряженных снарядов
...
- [[Configuration & Dynamic GameRules|ru_ru-26.2-Configuration-and-GameRules]]
- [[Architecture & Mixins|ru_ru-26.2-Architecture-and-Mixins]]
- [[Return to Overview Portal|ru_ru-26.2-Home]]
