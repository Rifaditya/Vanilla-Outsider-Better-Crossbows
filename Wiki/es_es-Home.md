...
| :--- | :--- | :--- | :---: | :--- |
| **Minecraft 26.3** | `1.0.14+26.3` | Fabric Loader `>=0.19.3` / Java 25 | 🟢 Activo principal | [[👉 Entrar a la Wiki de MC 26.3|es_es-26.3-Home]] |
| **Minecraft 26.2** | `1.0.14+26.2` | Fabric Loader `>=0.19.3` / Java 25 | 🟡 Paridad | [[👉 Entrar a la Wiki de MC 26.2|es_es-26.2-Home]] |
...
- **[[Mecánica de tensado rápido|es_es-26.3-Quick-Draw-Mechanics]]**:
  - Duración de recarga ajustable en ticks del servidor, con compatibilidad total para Carga rápida (Quick Charge).
- **[[Configuración y GameRules|es_es-26.3-Configuration-and-GameRules]]**:
